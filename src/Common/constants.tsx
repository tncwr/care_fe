...
export const BED_TYPES: Array<OptionsType> = [
  { id: 1, text: "Non-Covid Non O2 Beds" },
  ...
  { id: 120, text: "Adult Covid Oxygen beds" },
  { id: 110, text: "Adult Covid ICU (ICU without ventilator)" },
  { id: 100, text: "Adult Covid Ventilators (ICU with ventilator)" },
  { id: 40, text: KASP_STRING + " Non O2 Beds" },
